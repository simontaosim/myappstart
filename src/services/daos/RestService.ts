    ...
    constructor(resource: string, connection: Connection) {
        ...
        switch (this.resource) {
            ...
            case "videos":
                ...
                this.listSelect = ['id', 'title', "cover", 'acl', 'createdDate', 'cateId', 'isPublished', 'updatedDate'];
                this.detailSelect = ['id', 'title', "body", 'address', 'acl', "cover", 'cateId', 'isPublished', 'createdDate', 'updatedDate'];
                this.searchSelect = ['title', 'body'];
                // this.relations = ['tags']
                break;
            case "video_cates":
                this.repository = connection.getRepository(VideoCategory);
                this.listSelect = ['name', 'id', 'fCategoryId'];
                this.detailSelect = ['name', 'id', 'fCategoryId'];
                this.searchSelect = ['name'];
                // this.relations = ['tags']
                break;
            default:
